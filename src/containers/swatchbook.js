            ...
            >
              ...
              <Col xs={24} sm={24} md={4} justify="center" gutter={16}>
                ...
                <Row type="flex" justify="center" align="middle" gutter={16}>
                  <Switch
                    onChange={(value) =>
                      this.onChangeStockFilter(value, fabricsUnfiltered)
                    }
                  />
                </Row>
              </Col>
                    ...
                    <Descriptions size="small" column={1}>
                      ...
                      <Descriptions.Item label="Stock">
                        {fabric.hetvai ? (
                          ...
                          >
                            In Stock, {fabric.total_stock}m
                          </span>
                        )}
                      </Descriptions.Item>
                      <Descriptions.Item label="Last Stock Update">
                        {fabric.last_stock_update}
                      </Descriptions.Item>
                    </Descriptions>
                  </Card>
                ))
